...
class SentimentClassificationSST(pl.LightningModule):
    ...
    def prepare_data(self):
        ...
        self.hparams.val_filename = "datasets/CoT/snli/generated_test_15_transformation.txt"
        # self.hparams.val_filename = "datasets/sci_chatgpt/test_data/test_snli.txt" 
...
class BertForSequenceClassification_dropout(BertPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
...
class BertForSequenceClassification_ip(BertPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
    ...
    Examples::
        ...
        embedding_outputs.requires_grad_(True)
        outputs = self.bert.forward2(
            input_ids,
            embedding_outputs,
            attention_mask=attention_mask,
            token_type_ids=token_type_ids,
        ...
        new_pooled_output = new_outputs[1]
...
class BertSentimentClassificationSST_dropout(SentimentClassificationSST):
    def __init__(self, hparams):
        super().__init__(hparams)
...
class BertSentimentClassificationSST_ip(SentimentClassificationSST):
    def __init__(self, hparams):
        super().__init__(hparams)
