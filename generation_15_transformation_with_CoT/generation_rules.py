...
data_file = 'NLI_dataset_using_LLM/data/snli/snli_train_original.json'  
prompt_file = 'NLI_dataset_using_LLM/prompt/Rule_prompt.txt'  
output_file = 'NLI_dataset_using_LLM/data/Rule.txt'  
